...
class UserRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_role" do
    assert_difference("UserRole.count") do
      post user_roles_url, params: { user_role: { add: @user_role.add, delete: @user_role.delete, edit: @user_role.edit, role_id: @user_role.role_id, update: @user_role.update, user_id: @user_role.user_id } }
    end
  ...
  test "should update user_role" do
    patch user_role_url(@user_role), params: { user_role: { add: @user_role.add, delete: @user_role.delete, edit: @user_role.edit, role_id: @user_role.role_id, update: @user_role.update, user_id: @user_role.user_id } }
